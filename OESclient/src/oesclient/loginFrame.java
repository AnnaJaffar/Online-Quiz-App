...
//    frame.setBounds(200,200,300,600);
  ...
  void loginButton1_actionPerformed(ActionEvent e) {
    try{
      if(!cameFromSignin)
      {
        System.out.println("sign up enter");
        InetAddress host = InetAddress.getLocalHost();
      ...
      {
          JOptionPane.showMessageDialog(null,"Sorry,After Clicking \"Sign In\" button once,You cannot click \"Sign Up \"\n Please close the program and try again","Sign Up Error",
                                        JOptionPane.ERROR_MESSAGE);
